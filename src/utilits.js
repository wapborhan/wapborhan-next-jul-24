...
export const jqueryFuntion = () => {
  $(window).on("load", function () {
    ...
    var portfoliowidth =
      ...
      10;
    var blogwidth =
      portfoliowidth + $(".blog").width() + $(".testimonials").width() - 10;
    var contactwidth =
      blogwidth + $(".contact").width() + $(".copyright").width() - 10;
  ...
  $(document).ready(function () {
    ...
    $("#why-link").on("click", function () {
      $("#wrapper").mCustomScrollbar("scrollTo", "#why", {
        scrollInertia: 1500,
      });
    });
